...
const Skills = () => {
  const skills = [
    ...
    { name: "TailwindCSS.", icon: images.tailwindcss },
  ];
  const experiences = [
    // {
    //   name: "Ingenieria en Sistemas (En Curso)",
    //   company: "Universidad de Buenos Aires",
    //   // desc: "Proyecto individual donde puedes chatear con otros usuarios en tiempo real.",
    //   year: "2024",
    // },
    {
    ...
    },
    {
      name: "Estudiante",
      company: "Henry",
      desc: "Bootcamp con +700 horas de programación basadas en prácticas y proyectos reales.",
      year: 2022,
    },
    {
      name: "Back-End & Front-End Developer",
      company: "Henry",
      desc: "Proyecto Individual con mas de +100 horas",
      year: 2022,
    },
    {
      name: "Front-End Developer",
      company: "Henry",
      desc: "Proyecto Grupal con mas de +300 horas",
      year: 2022,
    },
  ];
